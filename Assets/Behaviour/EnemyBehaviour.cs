...
namespace DungeonCreature
{
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        private void AddAttackArea()
        {
            ...
            var aggroAreaCollider = _aggroArea.AddComponent<CircleCollider2D>();
        ...
        public void Move()
        {
            ...
            if (direction.x != 0)
                _behaviourModel.ChangePosition(direction.x + _behaviourModel.ProvidePosition().X,
                    _behaviourModel.ProvidePosition().Y);
            else _behaviourModel.ChangePosition(_behaviourModel.ProvidePosition().X,
                direction.y + _behaviourModel.ProvidePosition().Y);
